...
int main() {
	...
	window = glfwCreateWindow(1024, 768, "Triangle (Linux Ubuntu)", NULL, NULL);
	if (window == NULL) {
	...
	do {
		...
		glVertexAttribPointer(
			0,			// attribute 0. No particular reason for 0, but most match the layout in the shader.
			3,			// size
			GL_FLOAT,	// type
			GL_FALSE,	// normalised?
			0,			// stride
